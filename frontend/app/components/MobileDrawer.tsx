...
import { X, MessageSquarePlus, History, LayoutDashboard, Settings, Shield, MessageCircle, Menu, Pill, LogOut, Plus } from 'lucide-react';
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-[var(--border-color)]">
                <span className="text-2xl font-bold text-black" style={{ fontFamily: '"Brush Script MT", "Apple Chancery", "Lucida Handwriting", cursive' }}>Lumora</span>
                  ...
                  return (
                    <Link key={link.href} href={link.href} onClick={() => setIsOpen(false)}>
                      <div className={`flex items-center gap-3 p-3 rounded-lg transition-all ${
                        active ? 'bg-white/20 border-l-4 border-white text-black' : 'text-[var(--text-secondary)] hover:bg-zinc-800/50'
                      }`}>
                        <Icon size={20} />
